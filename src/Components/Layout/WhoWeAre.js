...
const WhoWeAre = () => {
  return (
    <div className='card'>
        ...
        <div className="row-card">
            <div className='row-card-column1'>
              <img className='boss-cropper' src={ Boss2 } alt = "Landing Page"/>
              </div>
            <div className='row-card-column2-boss'>
            <h2>Gurpreet Samra</h2>
              Vice President @ Tera
            </div>
        </div>
        <div className="row-card">
            <div className='row-card-column1'>
              <h2>Pavit Deep Singh</h2>
                Chief Operating Officer @ Tera
              </div>
            <div className='row-card-column2'>
              <img className='pavit-cropper' src={ Boss3 } alt = "Landing Page"/>
            </div>
        </div>
    </div>
  )
